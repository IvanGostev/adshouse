                                ...
                                <form class="row" action="{{route('moderator.qrcode.index')}}">
                                    ...
                                    <div class="col-sm-12 col-md-2">
                                        <div>
                                            ...
                                            <div class="fht-cell">
                                                <div class="filter-control">
                                                    <input type="text" value="{{request()['street'] ?? ''}}" name="street" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="filter-control">
                                                    <select
                                                        ...
                                                        @foreach($types as $type)
                                                            <option {{request()['room_type_id'] == $type->id ? 'selected' : '' }} value="{{$type->id}}">{{$type->title}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-sm-12 col-md-2">
                                        <div>
                                            ...
                                            <div class="fht-cell">
                                                <div class="filter-control">
                                                    <input type="text" value="{{request()['email'] ?? ''}}" name="email" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-2">
                                        <div>
                                            ...
                                            <div class="fht-cell">
                                                <div class="filter-control">
                                                    <input type="number" value="{{request()['paginateNumber'] ?? 12}}" name="paginateNumber" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12  col-md-2 d-flex gap-2">
                                        ...
                                        <a href="{{route('moderator.qrcode.index')}}" class="btn btn-secondary mt-3" tabindex="0"
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    @foreach($qrcodes as $qrcode)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('moderator.qrcode.statistic', $qrcode->id)}}" class="btn btn-primary">Statistic</a>
                                            </td>
                                            <td>
